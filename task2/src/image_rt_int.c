...
int main(void) {
  ...
  image_gray = malloc(SIZE_X * SIZE_Y * sizeof(int)); // gray scale image
  image_ascii = malloc(SIZE_X * SIZE_Y * sizeof(char));
  image_resize = malloc((SIZE_X * SIZE_Y * 3 / 4 + OFFSET) * sizeof(unsigned char));
